...
// FIX: Removed the explicit type annotation `{ [key: string]: React.ReactElement }`.
// This allows TypeScript to infer the specific props of each individual icon,
// which is necessary for `React.cloneElement` to correctly type-check the props.
const ICONS = {
  bot: (
